        ...
        <div class="footer-information">
            ...
            <div class="column">
                ...
                <div>
                    ...
                    <a href="https://www.twitter.com/flutcadeau" target="_blank"><i class="social-icon fab fa-twitter" aria-hidden="true"></i></a>
                    <a href="https://www.pinterest.com/flutcadeau" target="_blank"><i class="social-icon fab fa-pinterest-p" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    </div>
    <div class="footer-copyright">
        <p>© 2020 Flutcadeau. Alle rechten voorbehouden.</p>
    </div>
</footer>
<?php wp_footer(); ?>
</body>
